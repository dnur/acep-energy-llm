...
describe("#reset", () => {
    function subject({ initialState = {
        ...
        expect(updatedStated).not.toEqual(Object.assign(Object.assign({}, DEFAULT_STATE), initialState));
        driver.reset();
    ...
    it("Resets state back to the initial state provided at initialization", () => {
        ...
        expect(subject({ initialState })).toEqual(Object.assign(Object.assign({}, DEFAULT_STATE), initialState));
    });
