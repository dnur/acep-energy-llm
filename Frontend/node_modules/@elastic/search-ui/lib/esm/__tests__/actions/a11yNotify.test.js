...
describe("#a11yNotify", () => {
    ...
    it("does not run if hasA11yNotifications is false", () => {
        const { driver } = setupDriver(Object.assign(Object.assign({}, config), { hasA11yNotifications: false }));
        driver.a11yNotify("customMessage");
    ...
    it("logs expected console messages", () => {
        ...
        const { driver } = setupDriver(Object.assign(Object.assign({}, config), { debug: true }));
