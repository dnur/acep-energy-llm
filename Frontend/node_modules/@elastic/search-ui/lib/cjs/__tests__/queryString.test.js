...
describe("#parse", () => {
    function subject(value) {
        return queryString_1.default.parse(value);
    }
...
describe("#stringify", () => {
    function subject(value) {
        return queryString_1.default.stringify(value);
    }
