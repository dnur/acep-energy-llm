...
describe("adaptResponse", () => {
    ...
    it("adapts facets with empty values", () => {
        expect(adaptResponse(responseWithEmptyFacetValue)).toEqual(adaptedResponseWithEmptyFacetValue);
    });
    it("adapts facets with zero values", () => {
        expect(adaptResponse(responseWithZeroFacetValue)).toEqual(adaptedResponseWithZeroFacetValue);
    });
    ...
    it("will limit total pages to 100", () => {
        expect(adaptResponse(responseWithOver100Pages)).toEqual(adaptedResponseOver100Pages);
    });
});
