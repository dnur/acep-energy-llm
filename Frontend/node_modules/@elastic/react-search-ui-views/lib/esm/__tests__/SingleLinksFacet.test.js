...
it("renders correctly", () => {
    const wrapper = shallow(React.createElement(SingleLinksFacet, Object.assign({}, params)));
    expect(wrapper).toMatchSnapshot();
});
it("renders falsey values correctly", () => {
    const wrapper = shallow(React.createElement(SingleLinksFacet, Object.assign({}, params, { options: [
            {
                value: 0,
                count: 10,
                selected: false
...
it("renders with className prop applied", () => {
    ...
    const wrapper = shallow(React.createElement(SingleLinksFacet, Object.assign({}, params, { className: customClassName })));
