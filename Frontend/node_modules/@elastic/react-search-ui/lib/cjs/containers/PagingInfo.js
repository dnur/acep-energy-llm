...
exports.PagingInfoContainer = void 0;
const react_1 = __importStar(require("react"));
const __1 = require("..");
const react_search_ui_views_1 = require("@elastic/react-search-ui-views");
class PagingInfoContainer extends react_1.Component {
    render() {
        ...
        const View = view || react_search_ui_views_1.PagingInfo;
...
exports.default = (0, __1.withSearch)(({ pagingStart, pagingEnd, resultSearchTerm, totalResults }) => ({
    pagingStart,
    pagingEnd,
    resultSearchTerm,
    totalResults
